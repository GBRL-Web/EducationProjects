 ...
 */
final class Version20220624084636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address ALTER country_code TYPE VARCHAR(255)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE address ALTER country_code TYPE VARCHAR(50)');
